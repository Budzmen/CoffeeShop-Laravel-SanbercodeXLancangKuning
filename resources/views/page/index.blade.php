 ...
 <div class="container">
    <div class="about_section_2">
       <div class="row">
          ...
          <div class="col-md-6"> 
             <div class="image_iman"><img src="{{asset('template/images/about-img.png')}}" class="about_img"></div>
          </div>
       </div>
    </div>
 </div>
             ...
             <div class="container-fluid">
                <div class="row">
                   <div class="col-lg-3 col-md-6">
                      <div class="coffee_img"><img src="{{asset('template/images/img-1.png')}}"></div>
                   ...
                   <div class="col-lg-3 col-md-6">
                      <div class="coffee_img"><img src="{{asset('template/images/img-2.png')}}"></div>
                      <div class="coffee_box">
                   ...
                   <div class="col-lg-3 col-md-6">
                      <div class="coffee_img"><img src="{{asset('template/images/img-3.png')}}"></div>
                      <div class="coffee_box">
                   ...
                   <div class="col-lg-3 col-md-6">
                      <div class="coffee_img"><img src="{{asset('template/images/img-4.png')}}"></div>
                      <div class="coffee_box">
             ...
             <div class="client_section_2">
                <div class="client_taital_main">
                   <div class="client_left">
                      <div class="client_img"><img src="{{asset('template/images/client-img1.png')}}"></div>
                   </div>
 ...
 <div class="container">
    ...
    <div class="blog_section_2">
       <div class="row">
          <div class="col-md-6">
             <div class="blog_box">
                <div class="blog_img"><img src="{{asset('template/images/blog-img1.png')}}"></div>
          ...
          <div class="col-md-6">
             <div class="blog_box">
                <div class="blog_img"><img src="{{asset('template/images/blog-img2.png')}}"></div>
                <h4 class="date_text">05 April</h4>
